/// Entering the value for K (K Clusters)
...
// Generates a event when down key is press and run the algorithm and produce output
document.addEventListener('keydown',async()=>{
  if(!preventCallBack){
    preventCallBack=true
    let clusterCenterLocs=['meghanshu']
    let clusterCenterNewLocs=['bhatt']
...
/// Function for calculating new centroid postion
...
// Function for data assignment to the clusters
